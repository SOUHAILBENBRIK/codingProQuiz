...
class Home extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final UserAuth user = provider.Provider.of<UserAuth>(context);
    return Scaffold(
      body: SafeArea(
        child: Container(
              ...
              CarouselSlider(
                  ...
                  items: [
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context).pushNamed(AppRoute.difPage);
                        },
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context)
                            .pushReplacementNamed(AppRoute.offlineMultiplayer);
                      },
                      child: const CustomStack(
